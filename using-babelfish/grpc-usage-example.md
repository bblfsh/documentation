...
discover what languages the `bblfshd` currently supports. The [SupportedLanguagesResponse](https://github.com/bblfsh/sdk/blob/v3.2.2/protocol/driver.proto#L98)
